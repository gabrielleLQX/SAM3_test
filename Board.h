...
* V1.0 21/Feb/2005 JPP Suppress inline definition
* V1.1 21/Feb/05 JPP  : define __ramfunc
* V1.2 14/Oct/05 JPP  : Change MCK
*----------------------------------------------------------------------------
*/
#ifndef Board_h
#define Board_h
...
// mthomas: modified path & inline-definiton
#if 0
#include "include/AT91SAM3SD8.h"
#define __inline inline
#include "include/lib_AT91SAM3SD8.h"
#endif

#include "AT91SAM3SD8.h"
#define __inline static inline
#include "lib_AT91SAM3SD8.h"
...
/*-------------------------------*/
// The AT91SAM3SD8 embeds a 64-Kbyte SRAM bank, and 512 K-Byte Flash

#define  INT_SARM           0x20000000
#define  INT_SARM_REMAP	    0x20000000

#define  INT_FLASH          0x00000000
#define  INT_FLASH_REMAP    0x00000000 /* mt: fixed */
...
#define LED4            (1<<11)	/* PA3          & TWD  NPCS3  43 */
#define NB_LEB			4
